...
<link href="<?= 'http://' . $_SERVER['HTTP_HOST'] . '/docmark/css/edit-markup.css'?>" rel='stylesheet'>
      ...
      <a href="<?= 'http://' . $_SERVER['HTTP_HOST'] . '/docmark/carimbo-digital/index.php'?>" title="Carimbo Digital"><div id="nav1" class="nav nav1 diamond"><div class="rotCorrect"><i class="fa fa-edit fa-2x" aria-hidden="true"></i></div></div></a>
