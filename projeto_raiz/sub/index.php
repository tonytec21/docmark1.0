    ...
    <div class="inner-header flex">
      ...
      <h1>DocMark</h1>
        ...
        <div class='main-content-container'>
          <a class='container' style="text-decoration: none" href="<?= 'http://' . $_SERVER['HTTP_HOST'] . '/esperantinopolis/carimbo-digital/index.php'?>">
            <i class="fa fa-edit fa-2x" style="color: #fff" aria-hidden="true"></i><p style="color: #fff" class='image-caption'>Carimbo Digital</p>
          </a>

          <a class='container' style="text-decoration: none" href="<?= 'http://' . $_SERVER['HTTP_HOST'] . '/esperantinopolis/pdf-para-tiff/index.php'?>">
          ...
          <a class='container' style="text-decoration: none" href="<?= 'http://' . $_SERVER['HTTP_HOST'] . '/esperantinopolis/single-tif-para-pdf/index.php'?>">
          ...
          <a class='container' style="text-decoration: none" href="<?= 'http://' . $_SERVER['HTTP_HOST'] . '/esperantinopolis/chancela/index.php'?>">
